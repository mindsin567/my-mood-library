...
const StreaksAndBadges = () => {
    ...
    const isAchievementEarned = (achievementName) => {
    ...
    return (<div className="space-y-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <ShareCard moodStreak={streaks?.current_mood_streak || 0} journalStreak={streaks?.current_journal_streak || 0} achievementCount={earnedAchievements.length} totalAchievements={achievementDefinitions.length} displayName={displayName}/>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            return (<div key={achievement.id} className={`p-3 rounded-xl border transition-all ${earned
                  ...
                  {earned && (<Badge variant="outline" className="mt-2 text-xs">✓ Earned</Badge>)}
                </div>);
        })}
          </div>
        </CardContent>
