...
const BreathingCountGame = () => {
    ...
    return (<div className="space-y-4 text-center">
      ...
      {phase === 'playing' && (<>
          ...
          <button onClick={breathe} className="w-32 h-32 rounded-full bg-primary/10 border-2 border-primary/30 flex items-center justify-center mx-auto text-4xl font-bold text-primary hover:scale-105 transition-transform active:scale-95">
            {count}
          </button>
