...
const ShareCard = ({ moodStreak, journalStreak, achievementCount, totalAchievements, displayName }: ShareCardProps) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div
          ref={cardRef}
          className="rounded-2xl p-6 bg-gradient-to-br from-primary/10 via-accent/5 to-secondary border border-border overflow-hidden relative"
        >
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            ...
            {displayName && (
              <p className="text-sm text-muted-foreground mb-3">{displayName}'s progress</p>
            )}
