        ...
        <Tabs defaultValue="insights" className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  {isLoading ? (<div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    </div>) : summary ? (<div className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <Card>
                ...
                <CardContent>
                  {isLoading ? (<div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    </div>) : suggestions ? (<div className="prose prose-sm dark:prose-invert max-w-none">
          ...
          <TabsContent value="analytics">
            {dataLoading ? (<Card>
              ...
              </Card>) : (<MoodAnalytics moodEntries={allMoods}/>)}
          </TabsContent>
