        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {recommendedGames.map(gameId => {
              ...
              return (
                <Card key={gameId} className="cursor-pointer hover:scale-[1.02] transition-all hover:shadow-lg" onClick={() => setActiveGame(gameId)}>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {Object.entries(gameComponents).map(([id, game]) => (
              <Card key={id} className="cursor-pointer hover:scale-[1.02] transition-all hover:shadow-lg" onClick={() => setActiveGame(id)}>
                <CardHeader className="p-4 pb-2">
                  <CardTitle className="text-sm flex items-center gap-2">
                    <span className="text-xl">{game.emoji}</span> {game.title}
                  </CardTitle>
