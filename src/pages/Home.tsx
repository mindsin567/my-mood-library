...
const moodConfig: Record<MoodType, { icon: typeof Smile; color: string; label: string }> = {
          ...
          <Card>
            ...
            <CardContent>
              {recentMoods.length === 0 ? (
                <p className="text-muted-foreground text-sm">No mood entries yet. Start tracking!</p>
              ) : (
          ...
          <Card>
            ...
            <CardContent>
              {recentJournals.length === 0 ? (
                <p className="text-muted-foreground text-sm">No journal entries yet. Start writing!</p>
              ) : (
                <div className="space-y-3">
                  {recentJournals.map((entry) => {
                    ...
                    const Icon = config.icon;
                    return (
                      <div key={entry.id} className="p-3 rounded-lg bg-secondary/30">
