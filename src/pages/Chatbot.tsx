                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {quickPrompts.map((prompt) => (
                    <button
                      ...
                      className="px-3 py-1.5 text-xs rounded-full border border-primary/20 bg-primary/5 text-foreground hover:bg-primary/10 hover:border-primary/40 transition-all"
                    >
                      {prompt}
                    </button>
                  ))}
          ...
          <div className="p-4 border-t border-border/50 bg-background/50 backdrop-blur-sm">
            <div className="flex gap-2 items-center">
              <Input
                ...
                disabled={isLoading}
                className="flex-1 rounded-xl border-border/50 bg-background focus-visible:ring-primary/30"
              />
              <Button
                onClick={sendMessage}
